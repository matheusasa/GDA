            ...
            <section class="container cadastro">
                ...
                <div class="form">
                    <div class="column">
                        ...
                        </div><div class="agoravaimano">
                        <button class="btn btn-primary lupa" type="button"><i class="flaticon flaticon-search icon-sm" aria-hidden="true"></i></button>
                    </div></div>
                    <div class="column">
                        <div class="mod-box">
                            <label style="font-weight: bold;"><i class="fluigicon fluigicon-query-objective icon-sm" aria-hidden="true"></i>
                                Modalidade</label>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="Seu nome completo" required id="nome" name="nome" />
                        </div>
                        <div class="input-box">
                            <label><i class="flaticon flaticon-email icon-sm" aria-hidden="true"></i>
                                E-mail</label>
                            <input type="text" placeholder="seuemail@totvs.com.br" required id="email" name="email" />
                        </div>
                    </div>
                </div>
            </section>
