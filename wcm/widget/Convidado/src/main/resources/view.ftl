		...
		<div class="fluig-style-guide">
			<form role="form" id="formulario">
				<section class="container cadastro">
					...
					<header style="position:relative;">Solicitante Totvs</header>
					<div class="form">
						<div class="column">
							<div class="input-box">
						...
						<div class="column" style="display: none" id="FC">
								<div class="input-box">
									...
									<div class="input-box" style= "width: 420px"><input id="razao" name="razao" type="text" required="" placeholder="Ex: Totvs" style="width: 100%"/></div>
								</div>
								<div class="mod-box">
						...
						<div class="row column">
							<label style="font-weight: bold;"><i class="flaticon flaticon-group-config icon-sm" aria-hidden="true"></i> Nota de avaliação do evento
como um todo</label>
						</div>
						<div class="row column">
							<div class="rating" style=" margin-left:10px; float: left;">
								<input value="5" name="rate" id="star5" type="radio" style="display:none">
								<label title="text" for="star5"></label>
								<input value="4" name="rate" id="star4" type="radio" style="display:none">
								<label title="text" for="star4"></label>
								<input value="3" name="rate" id="star3" type="radio" style="display:none">
								<label title="text" for="star3"></label>
								<input value="2" name="rate" id="star2" type="radio" style="display:none">
								<label title="text" for="star2"></label>
								<input value="1" name="rate" id="star1" type="radio" style="display:none">
								<label title="text" for="star1"></label>
							</div>
						</div>
						<div class="row column">
							<label style="font-weight: bold;"><i class="flaticon flaticon-group-config icon-sm" aria-hidden="true"></i> Nota para medir o interesse no
serviço TOTVS</label>
						</div>
						<div class="row column">
							<div class="other-rating" style=" margin-left:10px; float: left;">
								<input value="10" name="other-rate" id="other-star5" type="radio" style="display:none">
								<label title="text" for="other-star5"></label>
								<input value="8" name="other-rate" id="other-star4" type="radio" style="display:none">
								<label title="text" for="other-star4"></label>
								<input value="6" name="other-rate" id="other-star3" type="radio" style="display:none">
								<label title="text" for="other-star3"></label>
								<input value="4" name="other-rate" id="other-star2" type="radio" style="display:none">
								<label title="text" for="other-star2"></label>
								<input value="2" name="other-rate" id="other-star1" type="radio" style="display:none">
								<label title="text" for="other-star1"></label>
							</div>
						</div>
						<div class="column">
							<div class="input-box">
