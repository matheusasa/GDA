					...
					<div class="form">
								...
								<div class="column">
									<div class="select-box">
										<select required="" name="processo" id="processo" class="form-control" style="height:100%;">
											<option hidden value="">Selecione o processo</option>
										</select>
									</div>
								</div>
							</div>
						...
						<div class="column">
								...
								<div class="column">
									<div class="select-box">
										<select required="" id="status" name="status" class="form-control"
											...
											<option value="Realizado com sucesso" required="" id="realizado" name="realizado">Realizado</option>
											<option value="Convidado ausente" required="" id="faltaC" name="faltaC">Falta de Convidado</option>
											<option value="Anfitrião ausente" required="" id="faltaA" name="faltaA">Falta do Anfitrião</option>
										</select>
									</div>
								</div>
							</div>
							<div class="input-box" id="FC" style="display: none">
								...
								<div class="selecione-box"><input class="selecione-texto" id="razao" name="razao" type="text" required="" style="width: 100%; font-size: 14px;" /></div>
							</div>
						</div>
						<div class="column" style="display: none" id="FCR">
							<div class="mod-box">
								...
								<div class="mod-option">
									<div class="mod">
										<input type="radio" id="mod" name="mod" required value="sim" />
										<label for="presencial" style="pointer-events: none; ">Sim</label>
									</div>
									<div class="mod">
										<input type="radio" id="mod" name="mod" required value="nao" />
						...
						<div class="column">
							<div class="input-box">
								<label><i class="fluigicon fluigicon-company icon-sm" aria-hidden="true"></i></i>
									Nota para o desempenho do Anfitrião</label>
								<div class="column">
									<div class="select-box">
